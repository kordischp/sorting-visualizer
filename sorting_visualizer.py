...
# Generate the array based on max value
def generate_array():
    try:
    ...
    generated_data = list(range(1, max_value + 1))
...
def play_sound(value1, value2):
    ...
    duration = 200  # Duration of sound in milliseconds
...
# Create and place max value label and entry
...
# Create and place algorithm selection dropdown
